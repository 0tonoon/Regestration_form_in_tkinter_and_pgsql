...
#basic variable and instance of sql
#change these creds here to ur data baser creds 
DB_HOST = "localhost"
DB_NAME = "nim"
DB_USER = "postgres"
DB_PASS = "13622"
...
def connect_database():
    ...
    if pnameEntry.get()=='' or phoneEntry.get()=='' or usernameEntry.get()=='' or passwordEntry.get()=='' or confirmEntry.get()=='':
        ...
        cursor.execute("INSERT INTO users (fullname,username,phonenumber,password) VALUES (%s,%s,%s,%s)",(fullname,username,phonenumber,password))
        conn.commit()
        print("insterted")
...
bgImage=ImageTk.PhotoImage(file="/home/kali/Desktop/all git/her code/pizza/Pizza_ordering-main/New folder/images/pizzasignup.png")
...
#pnameentry is the variabel that stors the form input value 
